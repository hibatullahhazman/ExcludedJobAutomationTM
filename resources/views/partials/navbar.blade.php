<nav class="navbar bg-body-tertiary">
    <div class="container-fluid">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-badge-tm-fill" viewBox="0 0 16 16">
      ...
      </svg> {{ __('Pengecualian Job Secara Automasi')}} </div>
